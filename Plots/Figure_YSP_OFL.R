...
pdf("Z:\\UW Google Drive\\Thesis Stuff\\SigmaOFL\\R\\Graphs\\Final Thesis Run\\Test\\All Species YSP.pdf", width=8.5, height=11)
...
for (s in 1:7) {
	...
	if (s%%2==0 | s==7) {
		legend(x="topright", legend=c(ProjStart, "Mean"), 
			bty="n", 
			pch=(c(19,19,19,NA)),
			lty=c(0,0,0,1), 
			col=colr, 
